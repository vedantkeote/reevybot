...
exports.default = {
    ...
    callback: ({ args, member: staff, guild, client, message, interaction }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const member = yield (guild === null || guild === void 0 ? void 0 : guild.members.fetch(userId));
            if (member) {
                const muteRole = guild === null || guild === void 0 ? void 0 : guild.roles.cache.find((role) => role.name === 'Muted');
                if (!muteRole) {
